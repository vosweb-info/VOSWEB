  ...
  <div class="bg-light">
    <b-container class="bg-white">
      ...
      <p>
        ...
        Gaisthalerhammer 6, 92539 Schönsee
      </p>
      <h4>Kontakt:</h4>
      <p>
        Telefon: 0 96 74 / 68 30 171<br />
        E-Mail: mail@vosweb.de<br />
      </p>
      <h4>Umsatzsteuer-ID:</h4>
      <p>
        Umsatzsteuer-Identifikationsnummer gem&auml;&szlig; §27 a
      ...
      <p>
        ...
        &uuml;bernehmen. Als Diensteanbieter sind wir gem&auml;&szlig; § 7 Abs.1
      ...
      <p>
        ...
        <a href="http://developers.facebook.com/docs/plugins/" target="_blank">
      ...
      <p>
        ...
        jedoch innerhalb von Mitgliedstaaten der Europ&auml;ischen Union oder in
        anderen Vertragsstaaten des Abkommens &uuml;ber den Europ&auml;ischen
        Wirtschaftsraum zuvor gek&uuml;rzt.
      </p>
      <p>
        Nur in Ausnahmef&auml;llen wird die volle IP-Adresse an einen Server von
        Google in den USA &uuml;bertragen und dort gek&uuml;rzt. Im Auftrag des
        Betreibers dieser Website wird Google diese Informationen benutzen, um
        Ihre Nutzung der Website auszuwerten, um Reports &uuml;ber die
      ...
      <p>
        <strong>
          Datenschutzerkl&auml;rung f&uuml;r die Nutzung von Google Adsense
        </strong>
      </p>
      <p>
      ...
      <p>
        ...
        Einstellung Ihrer Browser Software verhindern; wir weisen Sie jedoch
        darauf hin, dass Sie in diesem Fall gegebenenfalls nicht s&auml;mtliche
        Funktionen dieser Website voll umf&auml;nglich nutzen k&ouml;nnen. Durch
        die Nutzung dieser Website erkl&auml;ren Sie sich mit der Bearbeitung
        der &uuml;ber Sie erhobenen Daten durch Google in der zuvor
      ...
      <p>
        ...
        die Google-Dienste f&uuml;r Sie und andere zu verbessern. Um die Google
        +1-Schaltfl&auml;che verwenden zu k&ouml;nnen, ben&ouml;tigen Sie ein
        weltweit sichtbares, &ouml;ffentliches Google-Profil, das zumindest den
        f&uuml;r das Profil gew&auml;hlten Namen enthalten muss. Dieser Name
      ...
      <p>
        <em
          ...
          <a
            ...
            target="_blank"
          >
            Google Adsense Datenschutzerkl&auml;rung
          </a>
          ,
          <a
            href="http://www.google.com/intl/de/+/policy/+1button.html"
            target="_blank"
          >
            Google +1 Datenschutzerkl&auml;rung
          </a>
        </em>
      </p>
    </b-container>
